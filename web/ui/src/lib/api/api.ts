import { gallery, list, statistics, wappalyzer, detail, searchresult, technologylist, runner, taglist, responsecodelist } from "@/lib/api/types";
...
const endpoints = {
  ...
  responsecode: {
    path: `/results/responsecode`,
    returnas: {} as responsecodelist
  },
  runners: {
    path: `/runners`,
    returnas: {} as runner[]
